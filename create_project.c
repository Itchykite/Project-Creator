                                                  ...
                                                  const char* extra_flags)
{
    ...
    switch (template_type)
    {
        case MAIN_TEMPLATE:
            ...
            {
                case EXT_C:
                    properties = create_template(project_name, filename, extension, build_system, extra_flags)
                    break;
                case EXT_CPP:
        ...
        case SDL2_OPENGL_TEMPLATE:
            switch (extension)
            {
                case EXT_C: break;
                case EXT_CPP: break;
                default:
                    fprintf(stderr, "Error:  Unsupported file extension for SDL2 OpenGL template.\n");
                    properties.err = ERR_UNSUPPORTED_EXTENSION;
                    break;
            }
...
ProjectTemplateProperties create_template(const char* project_name, const char* filename, SupportedExtension extension, SupportedBuildSystem build_system, const char* extra_flags)
{
    ProjectTemplateProperties properties = {0};
    properties.flags = "";
...
ProjectTemplateProperties create_sdl2_opengl_c_template(const char* project_name, const char* filename, SupportedExtension extension, SupportedBuildSystem build_system, const char* extra_flags)
{
    ProjectTemplateProperties properties = {0};
    properties.flags = "-lSDL2 -lGL";
    properties.code = sdl2_opengl_c_template;
